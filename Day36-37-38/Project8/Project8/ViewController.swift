...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if answerText == "" {
            showAlert(title: "Whoops!", message: "You need to select the letters.", actionTitle: "OK")
            return
        }
    ...
    func showAlert(title: String?, message: String?, handler: ((UIAlertAction) -> Void)? = nil, actionTitle: String?) {
